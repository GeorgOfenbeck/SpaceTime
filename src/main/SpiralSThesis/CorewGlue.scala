...
class CorewGlue(testsize: Int, radix_choice: Map[Int, Int], static_size: Option[Int] = None, interleaved: Boolean = false,
                thread: Boolean = true, base_default: Int = 0, twid_doinline: Boolean = true, twid_default_precomp: Boolean = true,
                validate: Boolean = true, inplace: Boolean = false, pignore_config: Boolean = false, inputstride: Boolean = false,
                pdoinline: Boolean = true, splitradix: Boolean = true)
  extends Core(radix_choice, interleaved, thread, base_default, twid_doinline, twid_default_precomp, inplace,
    doinline = pdoinline, pignore_config, psplitradix = splitradix) {
